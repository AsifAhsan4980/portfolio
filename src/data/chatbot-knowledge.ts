...
export const welcomeMessage: ChatResponse = {
    text: "Hi! I'm Asif. Ask me anything about my work, skills, or experience -- or pick a topic below.",
    chips: ["About Asif", "Skills", "Projects", "Experience", "Services", "Contact"],
};

export const fallbackResponse: ChatResponse = {
    text: "Hmm, I'm not sure what you mean. I can tell you about my skills, projects, experience, services, education, or contact info. Try one of the options below!",
    chips: ["About Asif", "Skills", "Projects", "Experience", "Services", "Contact"],
};
...
export const intents: Intent[] = [
    {
        ...
        priority: 1,
        response: {
            text: "Hey there! I'm Asif. I can tell you about my skills, projects, experience, services, or how to get in touch. What are you curious about?",
    ...
    },
    {
        ...
        priority: 5,
        response: {
            text: "I'm a Senior Software Engineer with 6+ years of professional experience. I specialize in scalable distributed systems, real-time platforms, and cloud-native architectures.\n\nI've shipped 14+ projects across 5+ countries, serving 20+ clients and impacting 100K+ users.\n\nI hold a BSc in Computer Science from BRAC University and I'm based in Dhaka, Bangladesh.",
    ...
    },
    {
        ...
        priority: 4,
        response: {
            text: "I hold a BSc in Computer Science & Engineering from BRAC University (2016-2020), Dhaka, Bangladesh.\n\nDuring university I was active in:\n- BizBee Business Club — Assistant Director of IT\n- Chess Club — Director\n- Computer Club — Senior Executive",
    ...
    },
    {
        ...
        priority: 3,
        response: {
            text: "I'm based in Dhaka, Bangladesh. I've worked with clients across 5+ countries including Bangladesh, Canada, the USA, and Sweden.",
    ...
    },
    {
        ...
        priority: 6,
        response: {
            text: "Yes! I'm currently available for new projects. Whether it's full-stack web development, cloud architecture, API engineering, or mobile apps — I'm open to freelance, contract, and full-time opportunities.",
    ...
    },
    {
        ...
        priority: 8,
        response: {
            text: "Ticket Tomorrow is an online ticketing platform I built with complete frontend, backend, and admin dashboard. Features user, organization, ticketing, and promotion systems with bKash and SSLCommerz payment integration.\n\nOutcome: Reduced page load times by 60% using SSR and AWS CloudFront CDN.\n\nTech: Next.js, React, TypeScript, Redux, AWS Lambda, AppSync, DynamoDB, Cognito",
    ...
    },
    {
        ...
        priority: 8,
        response: {
            text: "ZodoLive is a global live streaming platform for iOS and Android. I built the entire admin dashboard from scratch — real-time stats, RBAC, glass UI theming, and Agora SDK integration.\n\nOutcome: 10,000+ active users. Real-time gifting processes thousands of transactions per minute.\n\nTech: Next.js, React, Node.js, TypeScript, AWS, PostgreSQL, GraphQL, Agora SDK",
    ...
    },
    {
        ...
        priority: 8,
        response: {
            text: "Nexus RTC SDK is my personal project — a production-grade, self-hosted real-time audio/video SDK (a full Agora RTC alternative). Includes media engine, signaling, analytics, and Kubernetes infrastructure.\n\nOutcome: Sub-50ms latency. ClickHouse analytics processes 1M+ QoE events per hour.\n\nTech: WebRTC, C++, Node.js, Kubernetes, Redis, ClickHouse, AWS",
    ...
    },
    {
        ...
        priority: 2,
        response: {
            text: "You're welcome! Feel free to ask anything else, or reach out directly if you'd like to collaborate.",
    ...
    },
    {
        ...
        priority: 4,
        response: {
            text: "I write about my technical projects and engineering insights. Check out the blog for deep-dives into building real products.",
            chips: ["Projects", "Skills"],
